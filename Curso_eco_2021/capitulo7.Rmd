...
## Alguns usos em Epidemiologia Espacial
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.align = "center", fig.width=7}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.width=6, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.width=7, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.width=7, fig.height=3, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.height=4, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, out.width = "100%", comment=NA, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE, fig.height=4, comment=NA, fig.align = "center"}
...
```{r, echo=T, warning=FALSE, results='asis', message = FALSE,fig.width=4, fig.height=4, comment=NA, fig.align = "center"}
...
cores <- c("#053061","#2166ac","#4393c3","#92c5de","#d1e5f0","#f7f7f7","#fddbc7","#f4a582","#d6604d", "#b2182b","#67001f")
